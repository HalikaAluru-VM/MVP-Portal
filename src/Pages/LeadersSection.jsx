...
const LeadersSection = () => {
  ...
  const {  subHeading, leaders } = leadersSection;
    ...
    <section className="mt-5">
      <div className="max-w-6xl  mx-auto px-4">
        ...
        <div className="relative flex items-center gap-2 justify-center">
          ...
          {/* Slider Card */}
          <div className="bg-gray-700 rounded-2xl shadow-2xl border border-gray-600 w-full mx-5 ">
...
<div className="flex justify-center mt-6 space-x-2">
  {leaders.map((_, index) => (
    <Button
      ...
      circle
      className={`w-2.5 h-2.5 md:w-3 md:h-3 p-0
        ${index === currentIndex ? "scale-110 bg-white" : "bg-gray-500"}`}
